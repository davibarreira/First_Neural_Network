...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #error = 0.5*np.average((y-final_outputs)**2) # Output layer error is the difference between desired target and actual output.
        ...
        delta_weights_i_h += np.matmul(X[:,None],hidden_error_term)*self.lr
        # delta_weights_i_h += hidden_error_term*X*learning_rate
        # delta_weights_i_h += hidden_error_term*learning_rate*X
        # Weight step (hidden to output)
        delta = output_error_term*hidden_outputs*self.lr
        delta_weights_h_o += delta.T
        # delta_weights_h_o += output_error_term*hidden_outputs*learning_rate
